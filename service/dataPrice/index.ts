...
import { getDataPrice, getDataSubscription } from "@/lib/stripe";
import { auth } from "../../auth";
import { db as prisma } from "@/lib/db";
export default async function getDataPriceUser() {
    ...
    try {
        ...
        const dataPrice = await getDataPrice(subscriptionId?.stripeSubscriptionId)
