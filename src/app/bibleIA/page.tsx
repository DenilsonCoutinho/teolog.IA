...
// import {AppSidebar} from "../components/menuSide"
...
//                 </Link>
//             </div> */}
//             <div className=" flex flex-col items-center justify-center max-w-[600px] mx-auto p-3 pb-28 md:gap-11 gap-10 mt-14">
...
export default function BibleIAcomponents() {
