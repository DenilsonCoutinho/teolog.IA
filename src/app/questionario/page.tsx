...
export default function Questionario() {
    ...
    const [loadingIsNewUser, setLoadingIsNewUser] = useState<boolean>(true);
    ...
    useEffect(() => {
        async function newUser() {
            ...
            const isNewUser = await IsNewUser(ID_USER)
            if (isNewUser?.hasCompletedQuestionnaire) {
                return route.replace("/bibleIA")
            }
            setLoadingIsNewUser(false)
        }
        newUser()
    }, [])
