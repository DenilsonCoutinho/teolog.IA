        ...
        <>
            ...
            <div className="flex flex-col justify-center items-center w-full h-dvh p-4">
                ...
                <div className="max-w-96 w-full">
                    ...
                    <Button disabled={isPending} onClick={() => submitAge()} className="mt-6 border w-full py-2 px-4 rounded-lg bg-gradient-to-r p-2 from-purple-800 to-blue-600 text-white transition" >
